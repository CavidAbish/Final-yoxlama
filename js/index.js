...
function getItemsFromLocalStorageAfterLoad() {
  ...
  addedDesignsAmount.innerText = designsAmount + " azn";
  totalAmount.innerText = designsAmount + " azn";
}
...
function createCardItem(btn) {
  ...
  addedDesignsAmount.innerText = designsAmount + " azn";
  totalAmount.innerText = designsAmount + servicesAmount + " azn";
}
